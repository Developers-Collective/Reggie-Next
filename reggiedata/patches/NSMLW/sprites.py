...
from core.sprites.sprite import static_sprite
...
class SpriteImage_NewerPokey(SLib.SpriteImage_StaticMultiple):  # 105
    ...
    def loadImages():
        ...
        for style in ("pumpkin", "jungle", "lava"):
            for i in range(8):
                SLib.loadIfNotInImageCache('Pokey%sTop' % style, 'pokey_%s_top.png' % style)
                SLib.loadIfNotInImageCache('Pokey%sMiddle' % style, 'pokey_%s_middle.png' % style)
                SLib.loadIfNotInImageCache('Pokey%sBottom' % style, 'pokey_%s_bottom.png' % style)
                SLib.loadIfNotInImageCache('Pokeysnowman%d' % i, 'pokey_snowman%d.png' % i)
    ...
    def dataChanged(self):
        ...
        if style == 2:
                if ('Pokeysnowman%d' % height) not in ImageCache:
                    return
                ...
                if ('Pokey%sTop' % color) not in ImageCache:
                    return
...
class SpriteImage_BlockElectricity(SLib.SpriteImage_Static):  # 630
    def __init__(self, parent):
        super().__init__(parent)
...
class SpriteImage_Komboo(SLib.SpriteImage_Static):  # 634
    SIZES = ['s', 'm']
...
class SpriteImage_KombooSpawner(SLib.SpriteImage_Static):  # 635
    SIZES = ['s', 'm']
...
class SpriteImage_BabyYoshiEgg(SLib.SpriteImage_StaticMultiple):  # 643
    _IMAGES = (
        ('Balloon', 'balloon'),
        ('Bubble', 'bubble'),
        ('Glow', 'glow'),
    ...
    @staticmethod
    def loadImages():
        if SpriteImage_BabyYoshiEgg._IMAGES[0][0] in ImageCache: return
        for i in range(len(SpriteImage_BabyYoshiEgg._IMAGES)):
            ImageCache[f'BabyYoshi{SpriteImage_BabyYoshiEgg._IMAGES[i][0]}Egg'] = SLib.GetImg(f'item_baby_yoshi_{SpriteImage_BabyYoshiEgg._IMAGES[i][1]}_egg.png')

    def dataChanged(self):
        color = (self.parent.spritedata[2] & 0xF0) >> 4

        s = f'BabyYoshi{SpriteImage_BabyYoshiEgg._IMAGES[color][0]}Egg'
        self.image = ImageCache[s] if ImageCache[s] else ImageCache[f'BabyYoshi{SpriteImage_BabyYoshiEgg._IMAGES[0][0]}Egg']

        super().dataChanged()



class SpriteImage_CoinStack(SLib.SpriteImage_StaticMultiple):  # 644
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (0, 0)
...
class SpriteImage_MoneyBag(SLib.SpriteImage_StaticMultiple):  # 645
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-3, -14)
    ...
    @staticmethod
    def loadImages():
        if 'MoneyBag0' in ImageCache: return
        for i in range(16):
            ImageCache[f'MoneyBag{i}'] = SLib.GetImg(f'money_bag_{i}.png')

    def dataChanged(self):
        color = self.parent.spritedata[2] & 0xF

        s = f'MoneyBag{color}'
        self.image = ImageCache[s] if ImageCache[s] else ImageCache[f'MoneyBag0']

        super().dataChanged()



class SpriteImage_BabyYoshiBalloon(SLib.SpriteImage_StaticMultiple):  # 646
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-1, -4)
    ...
    @staticmethod
    def loadImages():
        if 'BabyYoshiBalloon' in ImageCache: return
        ImageCache[f'BabyYoshiBalloon'] = SLib.GetImg(f'baby_yoshi_balloon.png')
...
class SpriteImage_BabyYoshiBubble(SLib.SpriteImage_StaticMultiple):  # 647
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-1, -4)
    ...
    @staticmethod
    def loadImages():
        if 'BabyYoshiBubble' in ImageCache: return
        ImageCache[f'BabyYoshiBubble'] = SLib.GetImg(f'baby_yoshi_bubble.png')
...
class SpriteImage_BabyYoshiGlow(SLib.SpriteImage_StaticMultiple):  # 648
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-1, -4)
    ...
    @staticmethod
    def loadImages():
        if 'BabyYoshiGlow' in ImageCache: return
        ImageCache[f'BabyYoshiGlow'] = SLib.GetImg(f'baby_yoshi_glow.png')
...
class SpriteImage_SpikeTrap(SLib.SpriteImage_StaticMultiple):  # 649
    def __init__(self, parent):
        super().__init__(parent)
...
class SpriteImage_WaterGeyser(SLib.SpriteImage_StaticMultiple):  # 652
    def __init__(self, parent):
        super().__init__(parent)
...
class SpriteImage_DryBonesNew(SLib.SpriteImage_StaticMultiple):  # 660
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-3, -16)
...
class SpriteImage_DryBonesWing(SLib.SpriteImage_StaticMultiple):  # 549
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-4, -16)
...
class SpriteImage_CameraScrollLimiter(SLib.SpriteImage_StaticMultiple):  # 662
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (0, 0)
...
class SpriteImage_Koton(SLib.SpriteImage_StaticMultiple):  # 664
    @staticmethod
    def loadImages():
...
class SpriteImage_WarpBox(SLib.SpriteImage_StaticMultiple):  # 665
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-8, -32)
    ...
    @staticmethod
    def loadImages():
        if 'WarpBox0_0' in ImageCache: return
        for type_ in range(16):
            for color in range(16):
                ImageCache[f'WarpBox{type_}_{color}'] = SLib.GetImg(f'warp_box/{type_:02d}/{color:02d}.png')

    def dataChanged(self):
        type_ = (self.parent.spritedata[1] >> 4) & 0xF
        color = self.parent.spritedata[1] & 0xF

        s = f'WarpBox{type_}_{color}'
        img = ImageCache[s] if ImageCache[s] else ImageCache[f'WarpBox0_0']
        self.image = img
...
class SpriteImage_LockedWarpBox(SLib.SpriteImage_StaticMultiple):  # 666
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-8, -32)
    ...
    @staticmethod
    def loadImages():
        if 'LockedWarpBox0_0' in ImageCache: return
        for type_ in range(16):
            for color in range(16):
                ImageCache[f'LockedWarpBox{type_}_{color}'] = SLib.GetImg(f'warp_box_locked/{type_:02d}/{color:02d}.png')

    def dataChanged(self):
        type_ = (self.parent.spritedata[1] >> 4) & 0xF
        color = self.parent.spritedata[1] & 0xF

        s = f'LockedWarpBox{type_}_{color}'
        img = ImageCache[s] if ImageCache[s] else ImageCache[f'LockedWarpBox0_0']
        self.image = img
...
class SpriteImage_LockedWarpBoxLey(SLib.SpriteImage_StaticMultiple):  # 667
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-4, -4)
    ...
    @staticmethod
    def loadImages():
        if 'LockedWarpBoxKey0_0' in ImageCache: return
        for type_ in range(16):
            for color in range(16):
                ImageCache[f'LockedWarpBoxKey{type_}_{color}'] = SLib.GetImg(f'warp_box_locked_key/{type_:02d}/{color:02d}.png')

    def dataChanged(self):
        type_ = (self.parent.spritedata[1] >> 4) & 0xF
        color = self.parent.spritedata[1] & 0xF

        s = f'LockedWarpBoxKey{type_}_{color}'
        img = ImageCache[s] if ImageCache[s] else ImageCache[f'LockedWarpBoxKey0_0']
        self.image = img
...
#    324: SpriteImage_Podouble,
    319: SLib.SpriteImage,
    322: SLib.SpriteImage,
    324: SLib.SpriteImage,
    ...
    585: SpriteImage_YoganBone,
    611: SpriteImage_Whomp,
    612: SpriteImage_Draglet,
    613: SpriteImage_Goombrat,
    614: SpriteImage_Tenten,
    617: SLib.SpriteImage,
#    618: SpriteImage_MessageBlock,
    618: SLib.SpriteImage,
    619: SpriteImage_Meteor,
    620: SpriteImage_FallingChestnut,
    622: SpriteImage_AngrySun,
    623: SpriteImage_Prongo,
    630: SpriteImage_BlockElectricity,
    634: SpriteImage_Komboo,
    635: SpriteImage_KombooSpawner,
    643: SpriteImage_BabyYoshiEgg,
    644: SpriteImage_CoinStack,
    645: SpriteImage_MoneyBag,
    646: SpriteImage_BabyYoshiBalloon,
    647: SpriteImage_BabyYoshiBubble,
    648: SpriteImage_BabyYoshiGlow,
    649: SpriteImage_SpikeTrap,
    652: SpriteImage_WaterGeyser,
    660: SpriteImage_DryBonesNew,
    549: SpriteImage_DryBonesWing,
    662: SpriteImage_CameraScrollLimiter,
    664: SpriteImage_Koton,
    665: SpriteImage_WarpBox,
    666: SpriteImage_LockedWarpBox,
    667: SpriteImage_LockedWarpBoxLey,
}
